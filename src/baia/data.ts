...
import type { RoomTier, Attraction, Activity, Testimonial } from "./types";
...
export const ROOMS: RoomTier[] = [
  {
    ...
    description:
      "A queen bed beneath a vaulted timber ceiling, a private terrace opening to the garden, and the sound of the sea just beyond the palms. Rollaway available for a third guest.",
    pricePerNight: 280,
    size: "20–22 m²",
  ...
  },
  {
    ...
    description:
      "The only front-row villa. A king bed and large sofa bed, a separate seating area, and a generous private entrance framing an uninterrupted view of the water from the moment you wake.",
    pricePerNight: 480,
    size: "45–50 m²",
...
export const ATTRACTIONS: Attraction[] = [
  {
    ...
    category: "Island",
    description:
      "A laid-back coastal village and the jump-off for Palawan's gentler island-hopping — white-sand islets, coral gardens, and calm turquoise bays a short boat ride from BAIA.",
    hiddenGem: false,
  ...
  },
  {
    ...
    category: "Nature",
    description:
      "A sheltered bay known for green sea turtle sightings and quiet snorkeling over shallow reefs — a peaceful half-day escape by boat from BAIA.",
    hiddenGem: false,
  ...
  },
  {
    ...
    category: "Island",
    description:
      "A small, tranquil island with a sweeping sandbar and pale shallows — ideal for a private picnic, wading, and undisturbed swimming.",
    hiddenGem: true,
  ...
  },
  {
    ...
    category: "Sights",
    description:
      "One of the longest continuous white-sand beaches in the Philippines — a vast, uncrowded shoreline perfect for long barefoot walks at sunrise.",
    hiddenGem: false,
  ...
  },
  {
    ...
    category: "Nature",
    description:
      "A cool, multi-tiered inland waterfall set in lush forest just behind San Vicente — a refreshing trek away from the coast.",
    hiddenGem: true,
  ...
  },
  {
    ...
    category: "Nature",
    description:
      "Winding mangrove channels where the river meets the sea — paddle or drift through a quiet nursery of birds, crabs, and rooted trees.",
    hiddenGem: true,
...
export const ACTIVITIES: Activity[] = [
  {
    ...
    category: "Adventure",
    description:
      "Drift between Port Barton's calm islets, Turtle Bay's reefs, and the sandbar at German Island aboard an authorized local outrigger that picks you up right on BAIA's shoreline.",
  ...
  },
  {
    ...
    category: "Nature",
    description:
      "Explore San Vicente at your own pace — cruise to Long Beach, the fishing village, and Pamuayan Falls on a scooter, moped, or bicycle rented at the front desk.",
  ...
  },
  {
    ...
    category: "Wellness",
    description:
      "Start your morning in our open-air beachfront shala. Gentle yoga flow, breathing, and ambient sound baths to harmonize your body with the rhythm of the sea.",
    duration: "90 Mins",
