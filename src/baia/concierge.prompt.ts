 ...
 *
 * HARD_RULES_BLOCK is shared with the TALA agent prompts
 * (tala/agent/tala.prompts.ts) so the pricing guardrail wording has exactly
 * one source of truth.
 */
import type { ConciergeConfig } from "./concierge.types";

export const HARD_RULES_BLOCK = [
  "==============================",
